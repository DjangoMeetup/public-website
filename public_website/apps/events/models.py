...
class UserEventGroupManager(models.Manager):
	def get_queryset(self, request):
		queryset = EventGroup.objects.filter(main_user_group=request.user)
		return queryset
...
class EventGroup(Group):
	...
	organisor_group = models.ManyToManyField(Person, 
...
class EventGroupOld(models.Model):
	...
	organisor_group = models.ManyToManyField(Person, 
		related_name='group_organisor_old', default='None', blank=True)
	main_user_group = models.ManyToManyField(Person, 
		related_name='group_user_old', default='None', blank=True)
